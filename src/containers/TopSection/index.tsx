...
// Add the Home link to <LandingSection>
        ...
        <TopSectionContainer>
            <LandingSection> 
                ...
                <InfoSection>
                  ...
                  <FloatingText style={{ display: "inline-flex" }}>TO
                    <OutlinedTextSvg viewBox="0 0 530 100">
                      <text>PARADISE</text>
                    </OutlinedTextSvg>
                  </FloatingText>
                  <DescriptionText>
                    Let us help you explore one of the largest countries in the world. 
                    Enjoy one of our three vacation packages where we will take care
                     of everything.
                  </DescriptionText>
                </InfoSection>
                <ViewMoreButton>
